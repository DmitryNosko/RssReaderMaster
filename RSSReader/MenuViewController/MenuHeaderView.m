...
- (void) setUp {
    ...
    [NSLayoutConstraint activateConstraints:@[
                                              ...
                                              [self.addResourceButton.trailingAnchor constraintEqualToAnchor:self.contentView.trailingAnchor constant:-150],
                                              [self.addResourceButton.centerXAnchor constraintEqualToAnchor:self.contentView.centerXAnchor],
