...
- (void) setUp {
    ...
    [NSLayoutConstraint activateConstraints:@[
                                              ...
                                              [self.newsLabel.leadingAnchor constraintEqualToAnchor:self.contentView.leadingAnchor],
                                              [self.newsLabel.trailingAnchor constraintEqualToAnchor:self.contentView.trailingAnchor constant:-140],
